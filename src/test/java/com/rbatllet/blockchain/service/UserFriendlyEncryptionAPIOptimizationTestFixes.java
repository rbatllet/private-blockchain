...
class UserFriendlyEncryptionAPIOptimizationTestFixes {

    private static final Logger logger = LoggerFactory.getLogger(UserFriendlyEncryptionAPIOptimizationTestFixes.class);
