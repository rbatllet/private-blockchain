...
show_getting_started_links() {
    ...
    echo "│     • docs/getting-started/GETTING_STARTED.md                                       │"
    echo "│     • docs/getting-started/EXAMPLES.md                                              │"
    echo "│                                                                                     │"
    echo "│  ⚡ Search Specialists:                                                              │"
    echo "│     • docs/search/SEARCH_FRAMEWORK_GUIDE.md                                         │"
    echo "│     • docs/search/SEARCH_COMPARISON.md                                              │"
    echo "│                                                                                     │"
    echo "│  🔧 Framework Developers:                                                           │"
    echo "│     • docs/reference/TECHNICAL_DETAILS.md                                           │"
    echo "│     • docs/reference/API_GUIDE.md                                                   │"
    echo "│                                                                                     │"
    echo "│  📋 Complete Comparison:                                                            │"
    echo "│     • docs/search/SEARCH_APIS_COMPARISON.md                                         │"
    echo "└─────────────────────────────────────────────────────────────────────────────────────┘"
    echo ""
}
...
show_next_steps() {
    ...
    echo "│     2. Read docs/getting-started/GETTING_STARTED.md                                   │"
    echo "│     3. Try the examples in docs/getting-started/EXAMPLES.md                           │"
    echo "│                                                                                       │"
    echo "│  ⚡ If you chose SearchSpecialistAPI:                                                  │"
    echo "│     1. ./scripts/run_search_framework_demo.zsh                                        │"
    echo "│     2. Read docs/search/SEARCH_FRAMEWORK_GUIDE.md                                     │"
    echo "│     3. Review docs/search/SEARCH_COMPARISON.md                                        │"
    echo "│                                                                                       │"
    echo "│  🔧 If you chose SearchFrameworkEngine:                                               │"
    echo "│     1. ./scripts/run_search_framework_demo.zsh                                        │"
    echo "│     2. Read docs/reference/TECHNICAL_DETAILS.md                                       │"
    echo "│     3. Study docs/reference/API_GUIDE.md                                              │"
    echo "│                                                                                       │"
